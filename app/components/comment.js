...
import {getFeedItemId} from './feeditem';
  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(getFeedItemId(), 4, this.props.commentId, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(getFeedItemId(), 4, this.props.commentId, callbackFunction);
      }
    }
  }
          ...
          {this.props.children}
            <br />
              <a href="#" onClick={(e) => this.handleLikeClick(e)} >
                {this.state.likeCounter.length} people {likeButtonText} </a> ·
              <a href="#">Reply</a> ·
